...
$fullMessage = $fullMessage."<tr ><td width=200px>How did you hear about KrNaturopathnYoga :</td> <td width=200px>".$howdid."</td></tr>";
...
$fullMessage = $fullMessage."<tr ><td width=200px>Message :</td> <td width=200px>".$message."</td></tr>";			
	...
	$admin="jogo2025@gmail.com";
			$to=$admin;
			$from=$mail;
			$subject="Online enquiry form jogo, from: $user " ;
		...
		mail($to1,$subject1,$fullMessage1,$header1);
			...
			echo "Thanks for contacting us! We will revert you shortly...<br>You may call on in case you want to speak to us";
		//	echo $mail."//".$name;
			echo "</div><br/>";
